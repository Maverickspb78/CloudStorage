...
//	private final FileCloudHandler cloudHandler = new FileCloudHandler(serverPath,clientPath,in,out, socket);
//	private final ListHandler listHandler = new ListHandler(serverPath, socket);
